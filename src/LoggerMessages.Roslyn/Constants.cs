...
namespace EventGroups.Roslyn
{
    public class Constants
    {
        ...
        public const string DefaultContent = @"using System;
                                               using Microsoft.LoggerExtensions.Logging;";

        public const string ILoggerTypeName = "ILogger";
        public const string ILoggerModuleName = "Microsoft.LoggerExtensions.Logging.Abstractions.dll";
        public const string ILoggerModuleNamespace = "Microsoft.LoggerExtensions.Logging";
    }
}
